...
export const REGIONS = [
  {
    ...
    latency: '24ms',
    clusters: [
      { id: 'c1', name: 'us-west-train-v4', type: 'H100 Pod', count: 2048, util: 94, status: 'healthy' },
      { id: 'c2', name: 'us-west-inf-01', type: 'T4 Pool', count: 512, util: 45, status: 'warning' }
    ]
  },
  {
    id: 'us-east',
    ...
    latency: '82ms',
    clusters: [
      { id: 'c3', name: 'us-east-train-02', type: 'TPU v5p', count: 1024, util: 98, status: 'healthy' }
    ]
  },
  {
    id: 'eu',
    ...
    latency: '145ms',
    clusters: [
      { id: 'c4', name: 'eu-central-gpu-2', type: 'A100 Superpod', count: 1024, util: 88, status: 'warning' },
      { id: 'c5', name: 'eu-west-inf-03', type: 'T4 Pool', count: 256, util: 60, status: 'healthy' }
    ]
  },
  {
    id: 'asia',
    ...
    latency: '110ms',
    clusters: [
      { id: 'c6', name: 'asia-ne-tpu-1', type: 'TPU v4', count: 2048, util: 95, status: 'healthy' }
    ]
  }
];
