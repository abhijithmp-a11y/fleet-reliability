...
export const ClusterDetail: React.FC<ClusterDetailProps> = ({ clusterId, onBack }) => {
  ...
  const [selectedNode, setSelectedNode] = useState<{sbId: string, bId: string, idx: number} | null>(() => {
    ...
    if (unhealthyIdx !== -1) {
      return { sbId: sb1.id, bId: b1.id, idx: unhealthyIdx };
    }
    return null;
  });
                                    ...
                                    return (
                                        <div 
                                          ...
                                          onClick={() => {
                                            ...
                                            else setSelectedNode({ sbId: sb.id, bId: block.id, idx });
                                          }}
                                          className={`
